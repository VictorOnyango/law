            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <nav class="nav nav-pills flex-column">
                    ...
                    <a href="<?= Url::to(['site/lawyer'])?>" class="nav-item nav-link active">
	        ...
	        <button class="btn btn-outline-success my-2 my-sm-0">Search</button>
				...
				<div class="row">
					<table class="table table-hover">
						...
						<tbody>
							<?php if(count($lawyer) > 0): ?>
								<?php foreach($lawyer as $lawyer): ?>
							<tr class="table-active">
								<th scope="row"><?php echo $lawyer->lawyerid; ?></th>
								<td><?php echo $lawyer->name; ?></td>
								<td><?php echo $lawyer->court; ?></td>
								<td><?php echo $lawyer->age; ?></td>
								<td><?php echo $lawyer->qualification; ?></td>
								<td><?php echo $lawyer->expertise; ?></td>
							</tr>
								<?php endforeach; ?>
							<?php else: ?>
								<tr>
