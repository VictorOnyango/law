            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               <ul class="nav nav-pills nav-stacked">
                  <li><a href="<?= Url::to(['site/index'])?>"><i class="fa fa-address-card-o"></i>Law Search</a></li>
                  <li><a href="<?= Url::to(['site/court'])?>"><i class="fa fa-list-ul"></i> Court search</a></li>
				  <li><a href="<?= Url::to(['site/lawyer'])?>"><i class="fa fa-list-ul"></i> Lawyer search</a></li>
                  <li><a href="<?= Url::to(['site/criminal'])?>"><i class="fa fa-list-ul"></i> Criminal search</a></li>
                  <li class="active"><a href="<?= Url::to(['site/update'])?>"><i class="fa fa-gear"></i> Update</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-8 bg-white padding-2 ">
            <h2><i>LAW UPDATE</i></h2> 
			<div class="row">
			<div class=col-md-6>
