        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               ...
               <a href="<?= Url::to(['law/create'])?>" class="nav-item nav-link ">
                    ...
                    <a href="<?= Url::to(['court/create'])?>" class="nav-item nav-link active">
          ...
          <div class="col-md-9 bg-white padding-2 ">
           <h1><?= Html::encode($this->title) ?></h1>
                <p>
                    <?= Html::a('Update', ['update', 'id' => $model->courtid], ['class' => 'btn btn-primary']) ?>
                    <?= Html::a('Delete', ['delete', 'id' => $model->courtid], [
