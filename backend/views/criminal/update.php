...
/* @var $model backend\models\Criminal */

$this->title = 'Update Criminal: ' . $model->criminalid;
$this->params['breadcrumbs'][] = ['label' => 'Criminals', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->criminalid, 'url' => ['view', 'id' => $model->criminalid]];
$this->params['breadcrumbs'][] = 'Update';
?>
<div class="criminal-update">
