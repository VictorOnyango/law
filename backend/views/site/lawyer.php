            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="<?= Url::to(['site/lawyer'])?>"><i class="fa fa-list-ul"></i> Lawyer Entry</a></li>
                  <li><a href="<?= Url::to(['site/criminal'])?>"><i class="fa fa-list-ul"></i> Criminal Entry</a></li>
                </ul>
              </div>
            </div>
          </div>
